package com.samuelangan.mycompagny.aop.logging;

import com.samuelangan.mycompagny.domain.ApplicationLog;
import com.samuelangan.mycompagny.domain.User;
import com.samuelangan.mycompagny.service.ApplicationLogService;
import com.samuelangan.mycompagny.service.UserService;
...
public class ApplicationLogAspect {
     ...
     */
    @Pointcut(
        "within(com.samuelangan.mycompagny.web.rest..*) && !execution(* com.samuelangan.mycompagny.web.rest.ApplicationLogResource.*(..)) "
    )
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    //    @Pointcut("within(@com.samuelangan.mycompagny.web.rest.annotations.AppLog *)")

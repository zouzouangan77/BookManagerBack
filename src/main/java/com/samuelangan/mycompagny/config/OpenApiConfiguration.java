...
public class OpenApiConfiguration {
    ...
    public static final String API_FIRST_PACKAGE = "com.samuelangan.mycompagny.web.api";
    ...
    public GroupedOpenApi apiFirstGroupedOpenAPI(
        ...
        return GroupedOpenApi.builder()
            .group("openapi")
            .addOpenApiCustomizer(jhipsterOpenApiCustomizer::customiseOpenApi)
    ...
    public OpenApiCustomizer customizer() {
        return openApi -> {
            openApi.info(new Info().title("Book Manager API").description("API documentation for Book Manager").version("v1.0"));
        };
    }
}

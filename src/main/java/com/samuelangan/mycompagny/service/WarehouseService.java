...
import com.samuelangan.mycompagny.repository.BoxRepository;
import com.samuelangan.mycompagny.repository.PositionRepository;
import com.samuelangan.mycompagny.repository.WarehouseRepository;
import com.samuelangan.mycompagny.service.dto.WarehouseDTO;
...
public class WarehouseService {
    ...
    public Page<WarehouseDTO> searchAllWarehouse(String search, Pageable pageable) {
        MatchOperation matchOperation = Aggregation.match(
            new Criteria().orOperator(Criteria.where("name").regex(search, "i"), Criteria.where("address").regex(search, "i"))
        );
        ...
        final Long totalCount = Optional.ofNullable(
            mongoTemplate.aggregate(aggregationCount, "ware_house", Document.class).getUniqueMappedResult()
        )

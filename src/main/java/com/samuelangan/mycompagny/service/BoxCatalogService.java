...
import com.samuelangan.mycompagny.repository.BoxCatalogRepository;
import com.samuelangan.mycompagny.service.dto.BookAvailableByWarehouseDTO;
import com.samuelangan.mycompagny.service.dto.BookAvailableDTO;
...
public class BoxCatalogService {
    ...
    public Page<BookAvailableDTO> getAllBoxCatalog(String search, Pageable pageable) {
        LookupOperation lookupOperationCatalog = LookupOperation.newLookup()
            .from("catalog")
            .localField("catalog")
            .foreignField("_id")
            .as("cat");
        LookupOperation lookupOperationBox = LookupOperation.newLookup().from("box").localField("box").foreignField("_id").as("bx");
        LookupOperation lookupOperationStockBox = LookupOperation.newLookup()
            .from("box_stock")
            .localField("box_stocks")
            .foreignField("_id")
            .as("boxStocks");
        LookupOperation lookupOperationWarehouse = LookupOperation.newLookup()
            .from("ware_house")
            .localField("bx.warehouse")
            .foreignField("_id")
            .as("wh");
        GroupOperation groupByTitleAndWarehouse = Aggregation.group("cat.book", "wh.name")
        ...
        ProjectionOperation nbBookAvailableOperation = Aggregation.project()
        ...
        GroupOperation groupByTitleOperation = Aggregation.group("book")
            .sum("nbBookAvailable")
            .as("nbBookAvailable")
            .addToSet("book")
            .as("book")
        ...
        final Long totalCount = Optional.ofNullable(
            mongoTemplate.aggregate(aggregationCount, "box_catalog", Document.class).getUniqueMappedResult()
        )
    ...
    public Page<BookAvailableByWarehouseDTO> getAllTitleByWarehouse(String search, Pageable pageable) {
        ...
        LookupOperation lookupOperationWarehouse = LookupOperation.newLookup()
            ...
            .foreignField("_id")
            .as("wh");
        LookupOperation lookupOperationPosition = LookupOperation.newLookup()
            .from("position")
        ...
        GroupOperation groupByWarehouseOperation = Aggregation.group("book")
            .sum("nbBookAvailable")
            .as("nbBookAvailable")
            .addToSet("book")
            .as("book")

...
import com.samuelangan.mycompagny.domain.Catalog;
import com.samuelangan.mycompagny.repository.*;
import com.samuelangan.mycompagny.service.dto.CatalogDTO;
...
public class CatalogService {
    ...
    public Page<CatalogDTO> searchAllCatalog(String search, Pageable pageable) {
        ...
        final Long totalCount = Optional.ofNullable(
            mongoTemplate.aggregate(aggregationCount, "catalog", Document.class).getUniqueMappedResult()
        )

...
import com.samuelangan.mycompagny.service.dto.BoxDTO;
...
public class BoxService {
    ...
    public Page<BoxDTO> searchAllBox(String search, Pageable pageable) {
        LookupOperation lookupOperationWH = LookupOperation.newLookup()
            .from("ware_house")
        ...
        final Long totalCount = Optional.ofNullable(
            mongoTemplate.aggregate(aggregationCount, "box", Document.class).getUniqueMappedResult()
        )
